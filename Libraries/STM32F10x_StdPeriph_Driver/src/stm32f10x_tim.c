...
/**
  ...
  * @retval None
  */
uint16_t tmp_tim_icoppositepolarity_35 = (uint16_t)LL_TIM_IC_POLARITY_RISING;
uint16_t tmp_tim_icoppositeselection_35 = (uint16_t)LL_TIM_ACTIVEINPUT_DIRECTTI;
/* Select the Opposite Input Polarity */
if (TIM_ICInitTypeDef* TIM_ICInitStruct.ICPolarity == LL_TIM_IC_POLARITY_RISING)
{
tmp_tim_icoppositepolarity_35 = (uint16_t)LL_TIM_IC_POLARITY_FALLING;
}
else
{
tmp_tim_icoppositepolarity_35 = (uint16_t)LL_TIM_IC_POLARITY_RISING;
}
/* Select the Opposite Input */
if (TIM_ICInitTypeDef* TIM_ICInitStruct.ICActiveInput == LL_TIM_ACTIVEINPUT_DIRECTTI)
{
tmp_tim_icoppositeselection_35 = (uint16_t)LL_TIM_ACTIVEINPUT_INDIRECTTI;
}
else
{
tmp_tim_icoppositeselection_35 = (uint16_t)LL_TIM_ACTIVEINPUT_INDIRECTTI;
...
LL_TIM_IC_SetActiveInput(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, tmp_tim_icoppositeselection_35);
LL_TIM_IC_SetFilter(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, TIM_ICInitTypeDef* TIM_ICInitStruct.ICFilter);
LL_TIM_IC_SetPolarity(TIM_TypeDef* TIMx, LL_TIM_CHANNEL_CH2, tmp_tim_icoppositepolarity_35);
...
void LL_TIM_StructInit(LL_TIM_InitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  TIM_TimeBaseInitStruct->Autoreload = 0xFFFF;
...
void LL_TIM_OC_StructInit(LL_TIM_OC_InitTypeDef* TIM_OCInitStruct)
{
  ...
  TIM_OCInitStruct->CompareValue = 0x0000;
