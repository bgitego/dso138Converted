...
# Added by Bahati
# Pathes to Legacy Libraries
APPLIBDIR1 = ./Legacy
STMLIBDIR1 = $(APPLIBDIR1)
LEGACYLIBSRSDIR = $(STMLIBDIR1)/src
LEGACYLIBINCDIR = $(STMLIBDIR1)/inc
...
# Added by Bahati
## Used Part of the legacy librarie(
SRC += $(LEGACYLIBSRSDIR)/legacy.c
...
#Added by Bahati
EXTRAINCDIRS += $(LEGACYLIBINCDIR) 
#EXTRAINCDIRS += C:\Engineering\CodeSourcery G++ Lite\arm-none-eabi\include Commmented By Bahati, directory does not exist
...
CDEFS += -D$(SYSCLOCK_CL)
CDEFS += -DUSE_FULL_LL_DRIVER # Added By Bahati
