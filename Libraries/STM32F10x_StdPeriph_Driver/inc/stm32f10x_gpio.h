...
#define IS_GPIO_SPEED(SPEED) (((SPEED) == LL_GPIO_SPEED_FREQ_MEDIUM) || ((SPEED) == LL_GPIO_SPEED_FREQ_LOW) || \
...
typedef enum
{ LL_GPIO_MODE_ANALOG = 0x0,
  LL_GPIO_MODE_FLOATING = 0x04,
  LL_GPIO_MODE_INPUT = 0x28,
  LL_GPIO_MODE_INPUT = 0x48,
  LL_GPIO_MODE_OUTPUT = 0x14,
  LL_GPIO_MODE_OUTPUT = 0x10,
  LL_GPIO_MODE_ALTERNATE = 0x1C,
  LL_GPIO_MODE_ALTERNATE = 0x18
}GPIOMode_TypeDef;

#define IS_GPIO_MODE(MODE) (((MODE) == LL_GPIO_MODE_ANALOG) || ((MODE) == LL_GPIO_MODE_FLOATING) || \
                            ((MODE) == LL_GPIO_MODE_INPUT) || ((MODE) == LL_GPIO_MODE_INPUT) || \
                            ((MODE) == LL_GPIO_MODE_OUTPUT) || ((MODE) == LL_GPIO_MODE_OUTPUT) || \
                            ((MODE) == LL_GPIO_MODE_ALTERNATE) || ((MODE) == LL_GPIO_MODE_ALTERNATE))
...
LL_APB2_GRP1_ForceReset(LL_APB2_GRP1_PERIPH_AFIO);
void LL_APB2_GRP1_ReleaseReset(LL_APB2_GRP1_PERIPH_AFIO);
