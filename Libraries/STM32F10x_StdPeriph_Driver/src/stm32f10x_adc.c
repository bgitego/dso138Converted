...
void LL_ADC_DeInit(ADC_TypeDef* ADCx)
{
  ...
  else if (ADCx == ADC2)
  {
    ...
    LL_APB2_GRP1_ForceReset(LL_APB2_GRP1_PERIPH_ADC2);
    /* Release ADC2 from reset state */
    LL_APB2_GRP1_ReleaseReset(LL_APB2_GRP1_PERIPH_ADC2);
  }
  else
  {
    if (ADCx == ADC3)
    {
      ...
      LL_APB2_GRP1_ForceReset(LL_APB2_GRP1_PERIPH_ADC3);
      /* Release ADC3 from reset state */
      LL_APB2_GRP1_ReleaseReset(LL_APB2_GRP1_PERIPH_ADC3);
    }
  }
}
