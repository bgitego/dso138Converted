...
#define LL_FLASH_LATENCY_0                ((uint32_t)0x00000000)  /*!< FLASH Zero Latency cycle */
#define LL_FLASH_LATENCY_1                ((uint32_t)0x00000001)  /*!< FLASH One Latency cycle */
#define LL_FLASH_LATENCY_2                ((uint32_t)0x00000002)  /*!< FLASH Two Latency cycles */
...
FlagStatus LL_FLASH_IsPrefetchEnabled();
